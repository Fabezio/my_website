...
#cgu
  ...
  article.text-justify
    p Aucune reproduction, même partielle prévue à l’article L.122-5 du Code de la propriété intellectuelle, ne peut être faite de ce site sans l’autorisation du directeur de publication.
  ...
  article.text-justify
    ...
    p
  h3.subtitle.is-3 Règles d'usage d'Internet
  article.text-justify
  ...
  h3.subtitle.is-3 Droit applicable
  article.text-justify
    p Tant le présent site que les modalités et conditions de son utilisation sont régis par le droit français, quel que soit le lieu d’utilisation. En cas de contestation éventuelle, et après l’échec de toute tentative de recherche d’une solution amiable, les tribunaux français seront seuls compétents pour connaissance de ce litige.
      br
  ...
  article.text-justify
    p
      a(href='http://www.droitissimo.com') Droitissimo.com
      |  est titulaire des droits d’auteurs du modèle des CGU ci-dessus :
      br
